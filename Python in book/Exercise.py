...
# # print apple - elppa 2
# fruit = "apple"
# for i in range(len(fruit)-1,0-1,-1):
#    print(fruit[i])
...
# Exercise 13: There is a string method called count that is similar to
...
# Exercise 14: Take the following Python code that stores a string:
...
col_pos = str.find(':') # find where is ':' (colon)
print(col_pos)                 
number = str[col_pos + 1:]  # extract portion after :
print(number)               
